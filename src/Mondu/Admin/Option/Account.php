...
class Account extends Helper {
	public function register() {
		...
		add_settings_field(
			...
			'mondu-settings-account',
			'mondu_account_settings_general',
			[ 'label_for' => 'sandbox_or_production', 'tip' => __('Mondu\'s environment to use.', 'mondu')]
		);
		add_settings_field('api_token',
			...
			'mondu-settings-account',
			'mondu_account_settings_general',
			[ 'label_for' => 'api_token', 'tip' => __('API Token provided by Mondu.', 'mondu')]
		);
		...
		add_settings_field('send_line_items',
			...
			'mondu-settings-account',
			'mondu_account_settings_general',
			[ 'label_for' => 'send_line_items', 'tip' => __('Send the line items when creating order and invoice.', 'mondu'),]
		);
	}
