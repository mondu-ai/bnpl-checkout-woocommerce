...
class Account extends Helper {
	...
	public function register() {
		...
		add_settings_field(
			...
			array( $this, 'field_sandbox_or_production' ),
			'mondu-settings-account',
			'mondu_account_settings_general',
			array(
		...
		add_settings_field(
			...
			array( $this, 'field_send_line_items' ),
			'mondu-settings-account',
			'mondu_account_settings_general',
			array(
	 ...
	 */
	public function field_sandbox_or_production( $args = array() ) {
		$this->select_field(
			Plugin::OPTION_NAME,
			'sandbox_or_production',
			array(
	 ...
	 * @param array $args arguments.
	 */
	public function field_api_token( $args = array() ) {
		$this->text_field( Plugin::OPTION_NAME, 'api_token', $args['tip'] );
	}
	 ...
	 * @param array $args arguments.
	 */
	public function field_send_line_items( $args = array() ) {
		$this->select_field(
			Plugin::OPTION_NAME,
			'send_line_items',
			array(
